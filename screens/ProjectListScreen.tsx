    ...
    <div className="flex flex-col h-full bg-white">
      <div className="p-4 border-b border-slate-200">
        <input
          ...
          className="w-full px-3 py-2 text-base bg-slate-100 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400"
        />
      </div>
            ...
            <li key={project.id}>
                ...
                >
                    <div className="flex-1 min-w-0">
                        <p className="text-[17px] font-semibold text-orange-600 truncate">{project.name}</p>
